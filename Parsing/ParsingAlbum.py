...
image_number = 0
link = 'https://leonardohobby.by/ishop/tree_9538925242/'
api_url = 'http://127.0.0.1:8000/api/productalbum/'
...
try:
    ...
    product_album = all_product.find_all('div', class_='goods catalog-goods')

    for product in product_album:
        ...
        if image_url:
            ...
            if image_response.status_code == 200:
                image_path = f'album/image{image_number}.jpg'
